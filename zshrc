...
GIT_PROMPT_AHEAD="%F{red}ANUM%{$reset_color%}"
GIT_PROMPT_BEHIND="%F{cyan}BNUM%{$reset_color%}"
GIT_PROMPT_MERGING="%F{magenta}⚡︎%{$reset_color%}"
GIT_PROMPT_UNTRACKED="%F{red}u%{$reset_color%}"
GIT_PROMPT_MODIFIED="%F{yellow}d%{$reset_color%}"
GIT_PROMPT_STAGED="%F{green}s%{$reset_color%}"
